...
if(isset($_POST['chart_data'])){
    ...
    while ($row = mysqli_fetch_assoc($res)) {
        $result['total_appointments'][] = $row['total_appointments'];
        $date = date_create($row['appointment_date']);
        $result['date'][] = date_format($date,"F");
                ...
                <div class="container-fluid" id="content_container">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Appointments Chart</h6>
                        </div>
                        <div class="card-body">
    ...
    <script>
        $.ajax({
            ...
            success: function(result){
                ...
                type: 'line',
                data: {
                    labels: result2.date.map(date => date),
                    datasets: [{
                    label: "Appointments",
                    lineTension: 0.4,
                    ...
                    pointHitRadius: 10,
                    pointBorderWidth: 2,
                    data: result2.total_appointments.map(date => date),
                    }],
                },
                options: {
